...
const payables = {
  ...
  find: id => `/payables/${id}`,
  days: '/payables/days',
  findWithFormat: format => `/payables.${format}`,
}
...
const bulkAnticipations = {
  ...
  simulate: recipientId => `/recipients/${recipientId}/bulk_anticipations/simulate`,
}
...
const transfers = {
  ...
  transfersExport: id => `/transfers/${id}/receipt`,
}
...
const kyc = {
  identityCheck: {
    create: recipientId => `/recipients/${recipientId}/upgrade`,
    findOne: recipientId => `/recipients/${recipientId}/upgrade`,
    update: recipientId => `/recipients/${recipientId}/upgrade`,
    upgrade: recipientId => `/recipients/${recipientId}/upgrade/identity`,
    updateSettings: recipientId => `/recipients/${recipientId}/settings`,
  },
}

const kycLink = {
  create: recipientId => `/recipients/${recipientId}/kyc_link`,
}

const payments = {
  all: '/payments',
  create: '/payments',
  findOne: paymentId => `/payments/${paymentId}`,
